...
from .dependencies import (
    ...
    require_user_sync_token,
    resolve_ranking_scope_id,
...
from .services.ranking_service import (
    ...
    load_single_dimension_score,
    serialize_setting_snapshot,
    sync_after_chain_mutation,
...
# Routers extracted from this file (remaining routes still in transition below)
